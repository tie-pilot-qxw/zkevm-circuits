...
const MAX_NUM_ROW: usize = 3680;

#[test]
fn test_mcopy_trace() {
    // gen witness
    let witness = Witness::new(&get_chunk_data(
        "test_data/mcopy_test/trace/block_info.json",
        "test_data/mcopy_test/trace/tx_info.json",
        "test_data/mcopy_test/trace/tx_debug_trace.json",
        "test_data/mcopy_test/trace/tx_receipt.json",
        "test_data/mcopy_test/trace/bytecode.json",
    ));
