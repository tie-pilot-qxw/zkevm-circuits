...
fn mutate_public_tag(origin_value: public::Tag, mut value_delta: usize) -> public::Tag {
    ...
    match new_value {
        ...
        8 => public::Tag::BlockTxLogNum,
        9 => public::Tag::TxStatus,
        10 => public::Tag::TxFromValue,
        11 => public::Tag::TxToCallDataSize,
        12 => public::Tag::TxIsCreateCallDataGasCost,
        13 => public::Tag::TxGasLimit,
        14 => public::Tag::TxGasPrice,
        15 => public::Tag::TxCalldata,
        16 => public::Tag::TxLog,
        17 => public::Tag::TxLogData,
        18 => public::Tag::CodeSize,
        19 => public::Tag::CodeHash,
        _ => unreachable!(),
    }
}
