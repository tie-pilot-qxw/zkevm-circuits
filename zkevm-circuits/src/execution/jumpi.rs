    ...
    ExecutionGadget<F, NUM_STATE_HI_COL, NUM_STATE_LO_COL> for JumpiGadget<F>
{
    ...
    fn get_constraints(
        ...
        let delta = AuxiliaryOutcome {
            ...
            gas_left: ExpressionOutcome::Delta(-OpcodeId::JUMPI.constant_gas_cost().expr()),
...
mod test {
    ...
    fn assign_and_constraint() {
        ...
        let gas_left_before_exec = current_state.gas_left + OpcodeId::JUMPI.constant_gas_cost();
        let mut trace = prepare_trace_step!(0, OpcodeId::JUMPI, stack);
    ...
    fn assign_and_constraint_condzero() {
        ...
        let gas_left_before_exec = current_state.gas_left + GasCost::SLOW;
        let mut trace = prepare_trace_step!(0, OpcodeId::JUMPI, stack);
        trace.gas = gas_left_before_exec;
        let padding_begin_row = |current_state| {
            let mut row = ExecutionState::END_PADDING.into_exec_state_core_row(
