...
/// call_6负责接下来CALL指令的 gas，addr操作数，将stack_pointer置0执行新的CALL调用
    ...
    ExecutionGadget<F, NUM_STATE_HI_COL, NUM_STATE_LO_COL> for Call6Gadget<F>
{
    ...
    fn get_constraints(
        ...
        constraints.extend(config.get_exec_state_constraints(
            meta,
            ExecStateTransition::new(vec![ExecutionState::CALL_5], NUM_ROW, vec![], None),
        ));
        constraints
    }
    fn get_lookups(
    ...
    fn gen_witness(&self, trace: &GethExecStep, current_state: &mut WitnessExecHelper) -> Witness {
        ...
        let core_row_0 = ExecutionState::CALL_6.into_exec_state_core_row(
            trace,
            current_state,
            NUM_STATE_HI_COL,
            NUM_STATE_LO_COL,
