    ...
    ExecutionGadget<F, NUM_STATE_HI_COL, NUM_STATE_LO_COL> for SwapGadget<F>
{
    ...
    fn get_constraints(
        ...
        let delta = AuxiliaryOutcome {
            ...
            // SWAP1 - SWAP16 gas cost is FASTEST,
            // Only one of the representatives is used here
            gas_left: ExpressionOutcome::Delta(OpcodeId::SWAP1.constant_gas_cost().expr()),
...
mod test {
    ...
    fn run(opcode: OpcodeId, stack: Stack, expect_stack_top: U256) {
        ...
        let gas_left_before_exec = current_state.gas_left + OpcodeId::SWAP1.constant_gas_cost();
